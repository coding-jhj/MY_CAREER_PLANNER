...
import { completeTask } from "../../../../../lib/server/services/execution-service";
...
export async function POST(request: Request, { params }: RouteContext): Promise<NextResponse> {
  try {
    ...
    const record = await completeTask(new SupabaseExecutionRepository(createServerSupabaseClient()), taskId, body);
